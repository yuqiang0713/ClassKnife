...
public class FileUtil {
    ...
    public static final boolean safeDeleteFile(File file) {
        ...
        if (file.exists()) {
            ...
            if (!deleted) {
                com.yuqiang.aop.util.Log.e(TAG, "Failed to delete file, try to delete when exit. path: " + file.getPath());
                file.deleteOnExit();
            }
            return deleted;
        }
    ...
    public static void closeQuietly(Closeable closeable) {
        try {
            ...
            com.yuqiang.aop.util.Log.w(TAG, "Failed to close resource", e);
        }
    }
    ...
    public static String readFileAsString(String filePath) {
        ...
        try {
            ...
            com.yuqiang.aop.util.Log.e(TAG, "file op readFileAsString e type:%s, e msg:%s, filePath:%s",
            ...
            try {
                ...
                com.yuqiang.aop.util.Log.e(TAG, "file op readFileAsString close e type:%s, e msg:%s, filePath:%s",
                    e.getClass().getSimpleName(), e.getMessage(), filePath);
            }
        }
